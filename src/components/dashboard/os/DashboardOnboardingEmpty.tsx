...
function DashboardOnboardingEmptyInner({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgb(139_92_246/0.14),transparent_65%)]"
        aria-hidden
      />
      <div
      ...
      <div className="relative">
        {illustration ? (
          <div className="mx-auto mb-4 w-full max-w-[160px] animate-fade-in-scale">{illustration}</div>
        ) : icon ? (
