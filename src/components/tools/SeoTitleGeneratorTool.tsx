...
export function SeoTitleGeneratorTool() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'hook-mobile-sticky-actions fixed inset-x-0 bottom-0 z-30 border-t border-zinc-800/80 bg-zinc-950/95 backdrop-blur-xl sm:hidden',
      ...
      <section
        className="seo-title-results-section mt-6 max-md:overflow-x-hidden max-md:pb-0 sm:pb-2"
