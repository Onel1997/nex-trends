...
export function PricingEnterpriseSection({ onContact }: PricingEnterpriseSectionProps) {
  return (
    <section className="pricing-enterprise relative overflow-hidden rounded-[var(--dash-radius-lg)] border border-cyan-500/20 bg-gradient-to-br from-zinc-950 via-zinc-950 to-cyan-950/20 p-4 sm:p-6">
      <div
      ...
      <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-5">
        <div className="max-w-xl">
          ...
          <h3 className="mt-1 text-lg font-semibold tracking-tight text-white sm:text-xl">
            Skaliere Kundenlieferung mit White-Label & API
          </h3>
          <p className="dashboard-os-muted mt-2 text-[11px] leading-relaxed sm:text-xs">
            Für Agenturen mit mehreren Creators. Custom Onboarding, SLA,
            dedizierte Infrastruktur und Team-Rollen — angepasst an deinen Workflow.
          </p>
          <ul className="mt-3 grid gap-2 text-[11px] text-zinc-400 sm:mt-4 sm:grid-cols-2">
