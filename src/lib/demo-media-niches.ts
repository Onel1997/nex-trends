...
export const NICHE_MIXKIT_IDS: Record<DemoCatalogNiche, readonly number[]> = {
  Fitness: [
    ...
    52108, 52110, 52118, 50972, 52104, 1318, 608, 40248, 40758, 780, 40766, 2277, 2578,
    2280, 2448, 2466,
  ],
  Fashion: [
    805, 809, 50641, 23327, 44541, 44554, 44560, 42298, 9060, 39874, 39881, 44545, 44550,
    44551, 3456, 5201, 4059,
  ],
  Productivity: [
  ...
  Business: [
    308, 4809, 42648, 42664, 914, 918, 4547, 3653, 47005, 30012, 4832, 41541, 231, 4839,
    3372, 3508,
  ],
  Luxury: [
  ...
  Motivation: [
    46652, 33130, 12983, 9024, 8987, 5997, 46653, 46656, 8796, 23345, 33778, 6616, 2466,
    2499, 2523, 2580,
  ],
  'Side Hustle': [
...
export function resolveMediaNiche(niche?: string): DemoCatalogNiche {
  ...
  for (const catalogNiche of DEMO_CATALOG_NICHES) {
    const label = catalogNiche.toLowerCase()
    const slug = label.replace(/\s+/g, '-')
    if (q === label || q === slug || q.includes(label) || label.includes(q)) {
      return catalogNiche
    }
  }
